...
void	tccAddSyms(TCCState *l)
{
  ...
  ADD_SYM(yeCreateQuadInt2);
  ADD_SYM(ywCanvasNewPolygonExt);
  ADD_SYM(ywCanvasNewDrawableImg);
  ADD_SYM(ywCanvasDrawableSetPix);
  ADD_SYM(ywCanvasDrawableFinalyze);
  ADD_SYM(ywCanvasVFlip);
