...
void testBlockArray(void)
{
	...
	g_assert(yBlockArrayIsSet(test.array, 2));
	g_assert(!yBlockArrayIsSet(test.array, 3));
	g_assert(yBlockArraySetGetPtr(&test.array, 3, void *));
	g_assert(yBlockArraySetGetPtr(&test.array, 4, void *));
	g_assert(yBlockArraySetGetPtr(&test.array, 5, void *));
	g_assert(yBlockArrayIsSet(test.array, 3));
	g_assert(yBlockArrayIsSet(test.array, 4));
	g_assert(yBlockArrayIsSet(test.array, 5));
	g_assert(yBlockArrayGetBlock(test.array, 0) == 0x3c);
	yBlockArrayUnset(&test.array, 4);
	g_assert(!yBlockArrayIsSet(test.array, 4));
