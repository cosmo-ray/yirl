...
DEF(YB_TRY_GET_AT_STR, "try_get_at_str", separated_string)
...
DEF(YB_SET_STRING, "set_string", separated_string)
...
DEF(YB_IRET_INF, "iret_inf", separated_string)
