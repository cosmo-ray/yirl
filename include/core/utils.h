...
#define YUI_GET_FIRST_BIT(mask) __builtin_ctzll(mask)

#define YUI_GET_LAST_MASK_POS(mask) (mask == 0LU ? 0LU : 63LU - __builtin_clzll(mask))

#define YUI_COUNT_1_BIT(mask) (mask == 0LU ? 0LU : __builtin_popcountll(mask))
